        ...
        <div className="px-4">
          ...
          <AnimatePresence>
            {menuOpen && (
              ...
              >
                <div className="p-4 rounded-2xl" style={{ backgroundColor: 'rgba(38, 37, 37, 0.95)' }}>
                  {navLinks.map((link, i) => (
                    <motion.a
                      key={i}
                      href={link.href}
          ...
          <>
            ...
            >
              <div className="p-8 border-b" style={{ borderColor: 'rgba(236, 179, 55, 0.2)' }}>
                <img src={logo} alt="InterRenta" className="h-10 w-auto object-contain" />
              </div>
              ...
              <div className="p-6 border-t" style={{ borderColor: 'rgba(236, 179, 55, 0.2)' }}>
                <p className="text-center text-sm" style={{ color: '#6b7280' }}>© 2025 InterRenta</p>
              </div>
            </motion.div>
          </>
        )}
