    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-10">
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/90 backdrop-blur ${status.glow} shadow-lg`}>
      ...
      <div className="p-6">
        ...
        {(property.sector || property.address) && (
          <p className="text-sm mb-4 flex items-center gap-1 line-clamp-1" style={{ color: '#9ca3af' }}>
        ...
        {/* Precio */}
        <div className="flex items-end justify-between pt-4 mb-4" style={{ borderTop: '1px solid #3a3a3a' }}>
          <div>
